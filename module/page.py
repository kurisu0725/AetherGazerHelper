...
class Page:
    ...
    @classmethod
    def display_all_pages_parent(cls):
        """Display all pages and their parents.

        Returns:
            str: All pages and their parents.
        """
        return "\n".join([f"{page}: {page.parent}" for page in cls.all_pages.values()])
    ...
    def __init__(self, check_button: Template, switch: Switch = None):
        ...
        self.switch = switch
        self.links = {}
        self.is_blind = {}  # modified, while True means that button don't need templatematching
    ...
    def link(self, button: Template, destination: Page, blind_to_click: bool = False):
        self.links[destination] = button
        self.is_blind[destination] = blind_to_click

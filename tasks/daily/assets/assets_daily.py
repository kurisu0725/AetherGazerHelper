...
SIGILS_MODULE_STAGE_1 = Template(
    filename=r"SIGILS_MODULE_STAGE_1.png",
    record_pos=(-0.4271, -0.0383),
    resolution=(1920, 1080),
    rgb=True,
    template_path="assets/daily",
)

SIGILS_MODULE_STAGE_2 = Template(
    filename=r"SIGILS_MODULE_STAGE_2.png",
    record_pos=(-0.1135, -0.0849),
    resolution=(1920, 1080),
    rgb=True,
    template_path="assets/daily",
)

SIGILS_MODULE_STAGE_3 = Template(
    filename=r"SIGILS_MODULE_STAGE_3.png",
    record_pos=(0.2055, -0.0268),
    resolution=(1920, 1080),
    rgb=True,
    template_path="assets/daily",
)

SIGILS_MODULE_FREE_REFRESH_CHECK = Template(
    filename=r"SIGILS_MODULE_FREE_REFRESH_CHECK.png",
    record_pos=(0.3477, 0.2396),
    resolution=(1920, 1080),
    keyword=Keyword(u'刷新'),
    rgb=False,
    template_path="assets/daily",
)

SIGILS_MODULE_FREE_REFRESH_CLICK = Template(
    filename=r"SIGILS_MODULE_FREE_REFRESH_CLICK.png",
    record_pos=(0.3099, 0.2401),
    resolution=(1920, 1080),
    rgb=True,
    template_path="assets/daily",
)
